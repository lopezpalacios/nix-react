...
The following README takes creative-tim's dashboard and uses a nix shell to test the layout without installing npm.

if you have not yet download nix on your system, run the following on MacOS:
```
...
- Clone the repo: `git clone https://github.com/lopezpalacios/nix-react.git`.
